...
class getSecurity_User_Provider_Concrete_UsersInMemoryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['security.user.provider.concrete.users_in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(['admin' => ['password' => '12345678', 'roles' => ['-\'ROLE_ADMIN\' -\'ROLE_USER\'']]]);
    }
}
