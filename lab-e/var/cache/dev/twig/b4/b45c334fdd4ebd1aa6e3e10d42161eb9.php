        ...
        foreach ($context['_seq'] as $context["_key"] => $context["measurement"]) {
            ...
            echo "</td>
                <td>
                    <a href=\"";
            // line 24
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_measurement_show", ["id" => twig_get_attribute($this->env, $this->source, $context["measurement"], "id", [], "any", false, false, false, 24)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 25
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_measurement_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["measurement"], "id", [], "any", false, false, false, 25)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
...
{% endblock %}
", "measurement/index.html.twig", "I:\\AI2-lab\\ai2-lab-c\\templates\\measurement\\index.html.twig");
    }
}
