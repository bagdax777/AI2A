...
class __TwigTemplate_9abaef46c2d3dae5c524bcf4c20d7a9e extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 28
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["location"]) || array_key_exists("location", $context) ? $context["location"] : (function () { throw new RuntimeError('Variable "location" does not exist.', 28, $this->source); })()), "langitude", [], "any", false, false, false, 28), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "location/show.html.twig", "I:\\AI2-lab\\ai2-lab-c\\templates\\location\\show.html.twig");
    }
}
